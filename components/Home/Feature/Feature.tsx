...
import { FaLayerGroup, FaDesktop, FaCog, FaHeadset, FaInfinity, FaBook, FaShieldAlt } from 'react-icons/fa'
...
const Feature = () => {
    const features = [
        ...
        },
        {
            ...
            text: 'Mulitple Layouts',
        },
        {
            icon: <FaLayerGroup className='text-yellow-500' />,
            text: 'Mobile Firs Design',
        },
        {
            ...
            <div className='w-[80%] mx-auto text-center'>
                ...
                <div className='grid mt-16 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                    {features.map((feature, index) => (
                        ...
                        key={index} className='flex items-center justify-center p-4 bg-white rounded-lg shadow-md space-x-3'>
